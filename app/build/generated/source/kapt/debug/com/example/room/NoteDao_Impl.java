...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `notes_table` (`title`,`description`,`priority`,`id`) VALUES (?,?,?,nullif(?, 0))";
      }
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `notes_table` SET `title` = ?,`description` = ?,`priority` = ?,`id` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<Note>> getAllNotes() {
    final String _sql = "SELECT *FROM notes_table ORDER BY priority ASC";
